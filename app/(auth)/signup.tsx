...
const styles = StyleSheet.create({
  ...
  imageHolder: { width: 100, height: 100, borderRadius: 50, backgroundColor: '#F2F2F7', borderWidth: 1, borderColor: '#E5E5EA', overflow: 'hidden', justifyContent: 'center', alignItems: 'center' },
  uploadedImage: { width: '100%', height: '100%' },
  imagePlaceholder: { alignItems: 'center' },
  imagePlaceholderText: { fontSize: 11, color: '#8E8E93', marginTop: 4, fontWeight: '500' },
  ...
  checkboxContainer: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: '#E5E5EA', borderRadius: 10, padding: 16, marginBottom: 12, backgroundColor: '#FAFAFC' },
  checkboxContainerActive: { borderColor: '#007AFF', backgroundColor: '#F2F8FF' },
  checkboxLabel: { flex: 1, fontSize: 15, color: '#1C1C1E', fontWeight: '500' },
  checkbox: { width: 22, height: 22, borderWidth: 2, borderColor: '#C7C7CC', borderRadius: 6, justifyContent: 'center', alignItems: 'center' },
  checkboxChecked: { borderColor: '#007AFF', backgroundColor: '#007AFF' },
  signupButton: { height: 52, backgroundColor: '#007AFF', borderRadius: 12, justifyContent: 'center', alignItems: 'center', marginTop: 15, shadowColor: '#007AFF', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 3 },
